...
export const planLimits: PlanLimit[] = [
  {
    ...
    pricingAxes: {
      ...
      customerBranding: "Logo, color, and basic branding",
    ...
    features: [
      "One public Smart Intake link",
      "Website scan + setup assistant",
      "Route-based intake questions",
      "Conditional photo upload — only when they help",
      "Clean, quote-ready briefs",
      "Required-photo handoff when needed",
  ...
  },
  {
    ...
    features: [
      "Everything in Smart Intake, plus:",
      "Multiple users (up to 10)",
      "Multiple intake links / sources",
      "Shared team inbox",
      "Assignments and internal notes",
      "Higher brief and photo volume — unlimited",
