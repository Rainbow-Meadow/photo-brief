 ...
 * Card — platform-aware.
 *
 * Use `interactive` when the card is clickable:
 * - Desktop: hover lift + shadow upgrade + border highlight (260ms ease).
 * - Mobile: tap scale + opacity feedback (100ms ease).
 * Platform behavior is driven by `.surface-card-interactive` in index.css.
 */

interface CardProps extends React.HTMLAttributes<HTMLDivElement> {
  /** Enables platform-aware hover (desktop) / tap (mobile) feedback. */
  interactive?: boolean;
}
