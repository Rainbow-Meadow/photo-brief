  ...
  return (
    <>
      ...
      <SlideStack>
        ...
        <RawSlide anchor="offer" label="What you get" tone="alt">
          <Section tone="alt">
            <Container>
              <SectionIntro
        ...
        <RawSlide anchor="agent" label="Apply (agent)">
          <Section id="agent">
            <Container>
              <SectionIntro
                eyebrow="[ Apply ]"
        ...
        <RawSlide anchor="quick-apply" label="Quick apply" tone="alt">
          <Section tone="alt">
            <Container width="narrow">
              <SectionIntro
                eyebrow="[ Quick apply ]"
        ...
        <RawSlide anchor="final-cta" label="Pick up the pen" tone="ink">
          <FinalCtaSection
